...
const BASE_URLS = {
    2023: 'http://results.beup.ac.in/ResultsBTech4thSem2023_B2021Pub.aspx',
    2024: 'http://results.beup.ac.in/ResultsBTech4thSem2025_B2022Pub.aspx',
};
...
module.exports = async (req, res) => {
    ...
    const sem = req.query.sem || "IV"; // Default to semester I if no sem is provided
    if (!reg_no || !year) {
